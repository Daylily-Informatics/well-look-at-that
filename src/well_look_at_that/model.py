...
TOKEN_EVENT_ACCOUNTING_COLUMNS = [
    ...
    "outcome_type",
    "attribution_confidence",
    "repo_attribution_method",
    "repo_attribution_confidence",
    "repo_attribution_evidence",
    "workstream_attribution_method",
    "workstream_attribution_confidence",
    "outcome_attribution_method",
    "outcome_attribution_confidence",
    "observed_event_sum_tokens",
    "cumulative_delta_tokens",
    "previous_cumulative_total_tokens",
    "delta_source",
    "is_window_baseline_event",
    "delta_input_tokens",
...
WINDOW_BOUNDARY_DIAGNOSTIC_COLUMNS = [
    ...
    "window_start",
    "window_end",
    "first_in_window_event_id",
    "first_in_window_at",
    "first_in_window_line_number",
    "first_in_window_cumulative_tokens",
    "first_in_window_delta_tokens",
    "previous_event_id",
    "previous_event_at",
    "previous_cumulative_tokens",
...
ATTRIBUTION_DIAGNOSTIC_COLUMNS = [
    ...
    "period_cumulative_delta_tokens",
    "token_event_count",
    "strong_attribution_share",
    "unknown_attribution_share",
    "evidence_path",
]
...
ECONOMIC_USAGE_COLUMNS = [
    ...
    "distinct_turn_count",
    "session_segment_count",
    "strong_attribution_tokens",
    "derived_attribution_tokens",
    "unknown_attribution_tokens",
    "strong_attribution_share",
    "unknown_attribution_share",
    "boundary_uncertain_tokens",
    "boundary_uncertain_share",
    "recommended_analysis_use",
]
...
ECONOMIC_READINESS_COLUMNS = [
    ...
    "strong_attribution_token_share",
    "derived_attribution_token_share",
    "boundary_uncertain_token_share",
    "recommended_use",
    "not_recommended_use",
]
